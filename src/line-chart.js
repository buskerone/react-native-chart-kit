          ...
          <G>
            ...
            <G>
                {withInnerLines
                    ...
                    : withHorizontalLabels && this.renderHorizontalLine({
                        ...config,
                        paddingTop,
                        paddingRight
                    })
            ...
            <G>
            {withHorizontalLabels && this.renderHorizontalLabels({
              ...config,
            ...
            <G>
                {withInnerLines
                    ...
                    : withVerticalLabels && this.renderVerticalLine({
                        ...config,
                        paddingTop,
                        paddingRight
                    })
            ...
            <G>
            {withVerticalLabels && this.renderVerticalLabels({
              ...config,
              labels,
              paddingRight,
              paddingTop
